...
public interface ExpandableObject {
    ...
    /**
     * Calculates the intersection of the shapes of the 2 objecta belonging to
     * this door.
     */
    TileShape get_shape();

    /**
     * Returns the dimension ot the intersection of the shapes of the 2 objecta
     * belonging to this door.
     */
    int get_dimension();

    /**
     * Returns the other room to p_room if this is a door and the other room is
     * a CompleteExpansionRoom. Else null is returned.
     */
