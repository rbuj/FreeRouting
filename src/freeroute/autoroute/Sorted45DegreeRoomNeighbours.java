            ...
            if (this.completed_room instanceof ObstacleExpansionRoom && this.sorted_neighbours.size() == 2) {
                ...
                if (intersection.is_empty()) {
                 ...
                 if (prev_neighbour.last_touching_side == next_neighbour.first_touching_side) {
                        ...
                        insert_incomplete_room = prev_neighbour.last_touching_side != (next_neighbour.first_touching_side + 1) % 8; // touch at a corner of the room shape
                    }
            }
        }else {
...
boolean[] edge_interiour_touches_obstacle;
    ...
    /**
     * Creates a new instance of SortedRoomNeighbour and calculates the first
     * and last touching sides with the room shape. this.last_touching_side will
     * be -1, if sorting did not work because the room_shape is contained in the
     * neighbour shape.
     */
