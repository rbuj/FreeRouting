            ...
            if (!next_neighbour.intersection.intersects(prev_neighbour.intersection)) {
                ...
                switch (next_neighbour.first_touching_side) {
                    case 0:
                        ...
                        } else if (prev_neighbour.intersection.ll.y > this.room_shape.ll.y
                    ...
                    case 1:
                        ...
                        } else if (prev_neighbour.intersection.ur.x < this.room_shape.ur.x
                    ...
                    case 2:
                        ...
                        } else if (prev_neighbour.intersection.ur.y < this.room_shape.ur.y
                    ...
                    case 3:
                        ...
                        } else if (next_neighbour.intersection.ur.y < this.room_shape.ur.y
