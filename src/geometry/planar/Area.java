...
public interface Area {
    ...
    /**
     * returns 2, if the area contains 2 dimensional shapes , 1, if it contains
     * curves, 0, if it is reduced to a points and -1, if it is empty.
     */
    int dimension();
    ...
    /**
     * Returns true, if p_point is contained in this area, but not inside a
     * hole. Being on the border is not defined for FloatPoints because of
