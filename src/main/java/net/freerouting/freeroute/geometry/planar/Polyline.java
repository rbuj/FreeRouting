...
public class Polyline implements java.io.Serializable {
            ...
            for (int j = i + 2; j < arr.length - 1; ++j) {
                ...
                if (!direction_changed) {
                    ...
                    if (next_border_line.side_of(corner_to_check) == Side.ON_THE_LEFT
                            ...
                            && next_border_line.side_of(this.corner(i - 1)) == Side.ON_THE_RIGHT) // an outstanding corner
                    {
            ...
            for (int j = i - 2; j >= 1; --j) {
                ...
                if (!direction_changed) {
                    ...
                    if (prev_border_line.side_of(corner_to_check) == Side.ON_THE_LEFT
                            ...
                            && prev_border_line.side_of(this.corner(i - 1)) == Side.ON_THE_RIGHT) // an outstanding corner
                    {
     ...
     * center line. 0 {@literal <}= p_no {@literal <}= arr.length - 3
     */
     ...
     * line. 0 {@literal <}= p_no {@literal <}= arr.length - 3
     */
