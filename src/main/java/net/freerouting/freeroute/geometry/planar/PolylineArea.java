...
public class PolylineArea implements Area, java.io.Serializable {
    ...
    private static void cutout_hole_piece(TileShape p_divide_piece, TileShape p_hole_piece,
    ...
    public PolylineArea(PolylineShape p_border_shape, PolylineShape[] p_hole_arr) {
        ...
        hole_arr = (p_hole_arr == null) ? null : p_hole_arr.clone();
    }
    ...
    public PolylineShape[] get_holes() {
        return (hole_arr == null) ? null : hole_arr.clone();
    }
     ...
     */
    public TileShape[] split_to_convex(net.freerouting.freeroute.datastructures.Stoppable p_stoppable_thread) {
