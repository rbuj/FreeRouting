...
/**
 * TileShapes whose border lines may have only directions out of a fixed set, as
 * for example orthoganal directions, which define axis parallel box shapes.
 *
 * @author Alfons Wirtz
 */
...
public abstract class RegularTileShape extends TileShape {
    ...
    /**
     * Compares the edglines of index p_edge_no of this regular TileShape and
     * p_other. returns Side.ON_THE_LEFT, if the edgeline of this simplex is to
     * the left of the edgeline of p_other; Side.COLLINEAR, if the edlines are
     * equal, and Side.ON_THE_RIGHT, if this edgeline is to the right of the
     * edgeline of p_other.
     */
