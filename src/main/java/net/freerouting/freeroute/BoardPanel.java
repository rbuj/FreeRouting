...
public final class BoardPanel extends javax.swing.JPanel {
    ...
    public void center_display(Point2D p_new_center) {
        ...
        repaint();
        this.board_handling.logfile.start_scope(net.freerouting.freeroute.interactive.LogfileScope.CENTER_DISPLAY);
        net.freerouting.freeroute.geometry.planar.FloatPoint curr_corner = new net.freerouting.freeroute.geometry.planar.FloatPoint(p_new_center.getX(), p_new_center.getY());
    ...
    public void set_selected_signal_layer(int p_signal_layer_no) {
        if (board_frame.savable_subwindows != null) {
            ((WindowSelectParameter) board_frame.savable_subwindows.get(SavableSubwindowKey.SELECT_PARAMETER))
