...
public final class WindowUnconnectedRoute extends WindowObjectListWithFilter {
     ...
     */
    private WindowUnconnectedRoute(BoardFrame p_board_frame) {
        super(p_board_frame);
    ...
    static WindowUnconnectedRoute getInstance(BoardFrame p_board_frame) {
        WindowUnconnectedRoute window = new WindowUnconnectedRoute(p_board_frame);
        p_board_frame.set_context_sensitive_help(window, "WindowObjectList_UnconnectedRoute");
        return window;
    }
