...
public abstract class Rule {
    ...
    public static void write_default_rule(WriteScopeParameter p_par, int p_layer) throws java.io.IOException {
        ...
        int default_cl_no = net.freerouting.freeroute.rules.BoardRules.default_clearance_class();
    ...
    private static void write_clearance_rules(WriteScopeParameter p_par,
        ...
        net.freerouting.freeroute.rules.ClearanceMatrix cl_matrix = p_par.board.rules.clearance_matrix;
