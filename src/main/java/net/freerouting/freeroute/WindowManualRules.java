...
public class WindowManualRules extends BoardSavableSubWindow {
    ...
    public WindowManualRules(BoardFrame p_board_frame) {
        ...
        this.via_rule_combo_box = new javax.swing.JComboBox<>(new DefaultComboBoxModel<>((ViaRule[]) routing_board.rules.via_rules.toArray()));
    ...
    public void refresh() {
        ...
        DefaultComboBoxModel<ViaRule> new_model = new javax.swing.DefaultComboBoxModel<>((ViaRule[]) routing_board.rules.via_rules.toArray());
