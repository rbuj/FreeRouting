...
public interface ObjectInfoPanel {
     ...
     */
    boolean append(net.freerouting.freeroute.geometry.planar.FloatPoint p_point);
     ...
     */
    boolean append_items(String p_link_name, String p_window_title, java.util.Collection<net.freerouting.freeroute.board.Item> p_items);
