...
import net.freerouting.freeroute.autoroute.AutorouteControl;
import net.freerouting.freeroute.autoroute.AutorouteControl.ExpansionCostFactor;
import net.freerouting.freeroute.autoroute.AutorouteEngine;
...
public class RoutingBoard extends BasicBoard implements java.io.Serializable {
     ...
     */
    public AutorouteEngine.AutorouteResult autoroute(Item p_item, net.freerouting.freeroute.interactive.Settings p_settings, int p_via_costs, Stoppable p_stoppable_thread, TimeLimit p_time_limit) {
        ...
        net.freerouting.freeroute.rules.Net route_net = rules.nets.get(route_net_no);
     ...
     * {@literal >}= 0. Returns an enum of type AutorouteEngine.AutorouteResult
     */
    public AutorouteEngine.AutorouteResult fanout(Pin p_pin, net.freerouting.freeroute.interactive.Settings p_settings, int p_ripup_costs,
    ...
    /**
     * Removes all trace tails of the input net. If p_net_no {@literal <}= 0,
     * the tails of all nets are removed. Returns true, if something was
     * removed.
     */
