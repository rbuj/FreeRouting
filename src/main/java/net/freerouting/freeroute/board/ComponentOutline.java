...
public class ComponentOutline extends Item {
    ...
    @Override
    protected net.freerouting.freeroute.geometry.planar.TileShape[] calculate_tree_shapes(ShapeSearchTree p_search_tree) {
        return new net.freerouting.freeroute.geometry.planar.TileShape[0];
    }
    ...
    public int get_draw_priority() {
        return net.freerouting.freeroute.boardgraphics.Drawable.MIDDLE_DRAW_PRIORITY;
    }
    ...
    @Override
    public net.freerouting.freeroute.geometry.planar.IntBox bounding_box() {
