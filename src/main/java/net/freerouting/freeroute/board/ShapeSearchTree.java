...
import net.freerouting.freeroute.autoroute.IncompleteFreeSpaceExpansionRoom;
 ...
 * @author Alfons Wirtz
 */
public class ShapeSearchTree extends net.freerouting.freeroute.datastructures.MinAreaTree {
     ...
     * p_shape. If p_layer {@literal <} 0, the layer is ignored
     */
     ...
     * list p_obstacles. If p_layer {@literal <} 0, the layer is ignored.
     */
     ...
     * Puts all tree entries overlapping with p_shape on layer p_layer into the
     * list p_obstacles. If p_layer {@literal <} 0, the layer is ignored.
     * tree_entries with object containing a net number of p_ignore_net_nos are
     * ignored.
     */
    ...
    /**
     * Puts all items in the tree overlapping with p_shape on layer p_layer into
     * p_obstacles, if p_obstacles != null. If p_layer {@literal <} 0, the layer
     * is ignored.
     */
     ...
     * overlap with exact calculation. If p_layer {@literal <} 0, the layer is
     * ignored.
     */
     ...
     * other items. If p_layer {@literal <} 0, the layer is ignored.
     */
