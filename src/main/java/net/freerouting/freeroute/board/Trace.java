...
public abstract class Trace extends Item implements Connectable {
    ...
    public int get_draw_priority() {
        return net.freerouting.freeroute.boardgraphics.Drawable.MAX_DRAW_PRIORITY;
    }
    ...
    public boolean is_shove_fixed() {
        ...
        net.freerouting.freeroute.rules.Nets nets = this.board.rules.nets;
        for (int curr_net_no : this.net_no_arr) {
            if (net.freerouting.freeroute.rules.Nets.is_normal_net_no(curr_net_no)) {
