...
public class ForcedViaAlgo {
    ...
    /**
     * Checks, if a Via is possible with the input parameter after evtl. shoving
     ...
     * may be damaged, so that an undo becomes necessesary.
     * p_trace_clearance_class_no and p_trace_pen_halfwidth_arr is provided to
     * make space for starting a trace in case the trace width is bigger than
     * the via shape. Returns false, if the forced via failed.
     */
