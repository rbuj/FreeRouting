...
public class Pin extends DrillItem {
    ...
    public java.util.Set<Pin> get_swappable_pins() {
        ...
        net.freerouting.freeroute.library.LogicalPart logical_part = component.get_logical_part();
    ...
    public double get_min_width(int p_layer) {
        ...
        net.freerouting.freeroute.geometry.planar.IntBox padstack_bounding_box = padstack_shape.bounding_box();
    ...
    public void print_info(ObjectInfoPanel p_window) {
        ...
        net.freerouting.freeroute.library.Padstack padstack = this.get_padstack();
