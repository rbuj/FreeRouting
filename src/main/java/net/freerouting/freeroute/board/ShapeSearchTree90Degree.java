...
import net.freerouting.freeroute.geometry.planar.OrthogonalBoundingDirections;
...
public class ShapeSearchTree90Degree extends ShapeSearchTree {
     ...
     */
    ShapeSearchTree90Degree(BasicBoard p_board, int p_compensated_clearance_class_no) {
