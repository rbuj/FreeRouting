...
import net.freerouting.freeroute.datastructures.ShapeTree.TreeEntry;
...
public abstract class Item implements Drawable, SearchTreeObject, ObjectInfoPanel.Printable, UndoableObjects.Storable, Serializable {
     ...
     */
    transient private net.freerouting.freeroute.autoroute.ItemAutorouteInfo autoroute_info = null;
    ...
    /**
     * Creates a copy of this item with id number p_id_no. If p_id_no
     * {@literal <}= 0, the id_no of the new item is generated internally
     */
     ...
     * p_net_no {@literal <}= 0, the net number is ignored.
     */
     ...
     * Returns the set of all Connectable items of the net with number p_net_no
     * which can be reached recursively via normal contacts from this item. If
     * p_net_no {@literal <}= 0, the net number is ignored. If p_stop_at_plane,
     * the recursive algorithm stops, when a conduction area is reached, which
     ...
     * {@literal <}= 0, the net numbers contained in this items are used instead
     * of p_net_no.
     */
     ...
     * p_id_no {@literal <}= 0, it w2ill be generated internally.
     */
    @Override
    ...
    /**
     * gets the p_no-th net number of this item for 0 {@literal <}= p_no
     * {@literal <} this.net_count().
     */
     ...
     * {@literal <} 0, the net items net number will be removed and the item
     * will no longer be connectable.
     */
     ...
     * not yet exist.
     */
    public net.freerouting.freeroute.autoroute.ItemAutorouteInfo get_autoroute_info() {
        if (autoroute_info == null) {
            autoroute_info = new net.freerouting.freeroute.autoroute.ItemAutorouteInfo(this);
        }
     ...
     */
    public net.freerouting.freeroute.autoroute.ItemAutorouteInfo get_autoroute_info_pur() {
        return autoroute_info;
    }
