...
/**
 *
 * Used internally for marking changed areas on the board after shoving and
 * optimizing items.
 *
 *
 * @author Alfons Wirtz
...
class ChangedArea {
     ...
     */
    public void join(net.freerouting.freeroute.geometry.planar.TileShape p_shape, int p_layer) {
        if (p_shape == null) {
            return;
        }
