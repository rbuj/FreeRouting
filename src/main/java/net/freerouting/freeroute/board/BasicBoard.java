...
public class BasicBoard implements java.io.Serializable {
     ...
     * the connection point. if p_net_no {@literal <} 0 traces of all nets are
     * combined.
     */
     ...
     * contains the point at p_location. If p_layer {@literal <} 0, the layer is
     * ignored. If p_item_selection_filter != null, only items of types selected
