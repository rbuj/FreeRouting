...
import net.freerouting.freeroute.board.OptViaAlgo;
...
public class SelectedItemState extends InteractiveState {
    ...
    public InteractiveState autoroute(Stoppable p_stoppable_thread) {
        ...
        for (Item curr_item : autoroute_item_list) {
            ...
            net.freerouting.freeroute.rules.Net route_net = hdlg.get_routing_board().rules.nets.get(curr_item.get_net_no(0));
            if (route_net != null) {
    ...
    public InteractiveState assign_clearance_class(int p_cl_class_index) {
        net.freerouting.freeroute.board.BasicBoard routing_board = this.hdlg.get_routing_board();
    ...
    public SelectedItemState info() {
        net.freerouting.freeroute.WindowObjectInfo.display(this.item_list, hdlg.get_panel().board_frame, hdlg.coordinate_transform, new java.awt.Point(100, 100));
        return this;
    }
