...
import net.freerouting.freeroute.datastructures.PlanarDelaunayTriangulation;
...
public final class NetIncompletes {
    ...
    public void draw(Graphics p_graphics, GraphicsContext p_graphics_context, boolean p_length_violations_only) {
        ...
        Collection<net.freerouting.freeroute.board.Pin> net_pins = this.net.get_pins();
        for (net.freerouting.freeroute.board.Pin curr_pin : net_pins) {
