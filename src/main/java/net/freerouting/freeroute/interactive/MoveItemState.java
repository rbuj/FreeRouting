...
public class MoveItemState extends InteractiveState {
    ...
    public static MoveItemState get_instance(FloatPoint p_location, Collection<Item> p_item_list,
        ...
        java.util.ResourceBundle resources = java.util.ResourceBundle.getBundle("net.freerouting.freeroute.interactive.resources.InteractiveState", p_board_handling.get_locale());
        ...
        net.freerouting.freeroute.board.BasicBoard routing_board = p_board_handling.get_routing_board();
            ...
            if (curr_item.is_user_fixed()) {
                ...
                Collection<Item> contacts = curr_item.get_connected_set(-1, true);
                {
                    for (Item curr_contact : contacts) {
                        if (curr_contact instanceof net.freerouting.freeroute.board.ConductionArea) {
    ...
    private void move(FloatPoint p_new_position) {
        ...
        if (!current_position.equals(previous_position)) {
            ...
            net.freerouting.freeroute.board.Components components = hdlg.get_routing_board().components;
            for (Component curr_component : this.component_list) {
