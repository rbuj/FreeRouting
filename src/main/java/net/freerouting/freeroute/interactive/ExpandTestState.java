...
import net.freerouting.freeroute.autoroute.InsertFoundConnectionAlgo;
import net.freerouting.freeroute.autoroute.LocateFoundConnectionAlgo;
import net.freerouting.freeroute.autoroute.MazeSearchAlgo;
...
public class ExpandTestState extends InteractiveState {
    ...
    private void init(FloatPoint p_location) {
        ...
        while (it.hasNext()) {
            ...
            if (curr_ob instanceof net.freerouting.freeroute.board.Connectable) {
        ...
        if (search_result != null) {
            ...
            this.autoroute_result
                    = LocateFoundConnectionAlgo.get_instance(search_result, control_settings,
                            ...
                            ripped_item_list, net.freerouting.freeroute.board.TestLevel.ALL_DEBUGGING_OUTPUT);
