...
public class Package implements Comparable<Package>, net.freerouting.freeroute.board.ObjectInfoPanel.Printable, java.io.Serializable {
    ...
    Package(String p_name, int p_no, Pin[] p_pin_arr, Shape[] p_outline,
        ...
        outline = (p_outline == null) ? null : p_outline.clone();
        keepout_arr = (p_keepout_arr == null) ? null : p_keepout_arr.clone();
        via_keepout_arr = (p_via_keepout_arr == null) ? null : p_via_keepout_arr.clone();
        place_keepout_arr = (p_place_keepout_arr == null) ? null : p_place_keepout_arr.clone();
        is_front = p_is_front;
