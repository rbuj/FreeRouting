...
public final class WindowNetClasses extends BoardSavableSubWindow {
    ...
    private final javax.swing.JComboBox<String> via_rule_combo_box;
    ...
    WindowNetClasses(BoardFrame p_board_frame) {
        ...
        net.freerouting.freeroute.board.BasicBoard routing_board = p_board_frame.board_panel.board_handling.get_routing_board();
    ...
    private class RemoveNetClassListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            for (int i = 1; i < board_rules.nets.max_net_no(); ++i) {
                net.freerouting.freeroute.rules.Net curr_net = board_rules.nets.get(i);
    ...
    private class AssignClassesListener implements java.awt.event.ActionListener {
        ...
        @Override
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            board_frame.savable_subwindows.get(SavableSubwindowKey.ASSIGN_NET_CLASSES).setVisible(true);
        }
    }
    ...
    private class SelectClassesListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            net.freerouting.freeroute.rules.Nets nets = routing_board.rules.nets;
            ...
            for (net.freerouting.freeroute.board.Item curr_item : board_items) {
                ...
                for (int i = 0; i < curr_item.net_count(); ++i) {
                    net.freerouting.freeroute.rules.NetClass curr_net_class = nets.get(curr_item.get_net_no(i)).get_class();
