...
public class InsertFoundConnectionAlgo {
    ...
    boolean insert_neckdown(Point p_from_corner, Point p_to_corner, int p_layer, net.freerouting.freeroute.board.Pin p_start_pin, net.freerouting.freeroute.board.Pin p_end_pin) {
        if (p_start_pin != null) {
    ...
    private Point try_neck_down(Point p_from_corner, Point p_to_corner, int p_layer, net.freerouting.freeroute.board.Pin p_pin) {
