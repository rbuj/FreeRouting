...
public interface CompleteExpansionRoom extends ExpansionRoom {
     ...
     */
    net.freerouting.freeroute.board.SearchTreeObject get_object();

    /**
     * Draws the shape of this room for test purposes
     */
    void draw(java.awt.Graphics p_graphics, net.freerouting.freeroute.boardgraphics.GraphicsContext p_graphics_context, double p_intensity);
}
