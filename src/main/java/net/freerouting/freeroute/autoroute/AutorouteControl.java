...
public class AutorouteControl {
     ...
     */
    public AutorouteControl(RoutingBoard p_board, int p_net_no, net.freerouting.freeroute.interactive.Settings p_settings) {
     ...
     * Creates a new instance of AutorouteControl for the input net
     */
    public AutorouteControl(RoutingBoard p_board, int p_net_no, net.freerouting.freeroute.interactive.Settings p_settings, int p_via_costs, ExpansionCostFactor[] p_trace_cost_arr) {
     ...
     */
    private AutorouteControl(RoutingBoard p_board, net.freerouting.freeroute.interactive.Settings p_settings,
    ...
    private void init_net(int p_net_no, RoutingBoard p_board, int p_via_costs) {
        ...
        net.freerouting.freeroute.rules.NetClass curr_net_class;
        if (curr_net != null) {
        ...
        for (int i = 0; i < via_rule.via_count(); ++i) {
            ...
            net.freerouting.freeroute.library.Padstack curr_via_padstack = curr_via.get_padstack();
