...
public abstract class LocateFoundConnectionAlgo {
     ...
     */
    public void draw(java.awt.Graphics p_graphics, net.freerouting.freeroute.boardgraphics.GraphicsContext p_graphics_context) {
    ...
    static final class ResultItem {
        ...
        private ResultItem(IntPoint[] p_corners, int p_layer) {
            corners = p_corners;
            layer = p_layer;
        }
    }
