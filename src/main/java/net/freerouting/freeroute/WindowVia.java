...
public final class WindowVia extends BoardSavableSubWindow {
    ...
    public void dispose() {
        ...
        JFrame edit_vias_window = board_frame.savable_subwindows.get(SAVABLE_SUBWINDOW_KEY.EDIT_VIAS);
    ...
    private class ShowPadstacksListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            net.freerouting.freeroute.library.BoardLibrary board_library = board_frame.board_panel.board_handling.get_routing_board().library;
    ...
    private class AddPadstackListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            net.freerouting.freeroute.library.Padstack new_padstack = pcb.library.padstacks.add(padstack_name, padstack_shapes, true, true);
    ...
    private class RemovePadstackListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            net.freerouting.freeroute.board.BasicBoard pcb = board_frame.board_panel.board_handling.get_routing_board();
            net.freerouting.freeroute.library.Padstack[] via_padstacks = pcb.library.get_via_padstacks();
    ...
    private class EditViasListener implements java.awt.event.ActionListener {
        ...
        @Override
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            board_frame.savable_subwindows.get(SAVABLE_SUBWINDOW_KEY.EDIT_VIAS).setVisible(true);
        }
    }
