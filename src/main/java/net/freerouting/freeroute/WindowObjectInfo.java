...
public final class WindowObjectInfo extends BoardTemporarySubWindow implements net.freerouting.freeroute.board.ObjectInfoPanel {
     ...
     */
    public static void display(Collection<net.freerouting.freeroute.board.Item> p_item_list,
            BoardFrame p_board_frame, net.freerouting.freeroute.board.CoordinateTransform p_coordinate_transform, java.awt.Point p_location) {
        ...
        for (WindowObjectInfo.Printable curr_object : p_item_list) {
            ...
            if (curr_object instanceof net.freerouting.freeroute.board.Pin) {
                ...
                ++via_count;
            } else if (curr_object instanceof net.freerouting.freeroute.board.Trace) {
                ++trace_count;
                cumulative_trace_length += ((net.freerouting.freeroute.board.Trace) curr_object).get_length();
            }
        }
    ...
    public static WindowObjectInfo display(String p_title, Collection<Printable> p_object_list,
            BoardFrame p_board_frame, net.freerouting.freeroute.board.CoordinateTransform p_coordinate_transform) {
    ...
    private final net.freerouting.freeroute.board.CoordinateTransform coordinate_transform;
     ...
     */
    @Override
    public boolean append_items(String p_button_name, String p_window_title, java.util.Collection<net.freerouting.freeroute.board.Item> p_items) {
        java.util.Collection<WindowObjectInfo.Printable> object_list = new java.util.LinkedList<>();
