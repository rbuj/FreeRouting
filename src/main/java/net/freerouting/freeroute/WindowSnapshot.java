...
public final class WindowSnapshot extends BoardSavableSubWindow {
    ...
    private class AddListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            net.freerouting.freeroute.interactive.SnapShot new_snapshot = net.freerouting.freeroute.interactive.SnapShot.get_instance(name_field.getText(), board_frame.board_panel.board_handling);
