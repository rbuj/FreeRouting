...
public class ClearanceMatrix implements java.io.Serializable {
     ...
     */
    public static ClearanceMatrix get_default_instance(net.freerouting.freeroute.board.LayerStructure p_layer_structure, int p_default_value) {
    ...
    /**
     * Sets the value of all clearance classes with number {@literal >}= 1 to
