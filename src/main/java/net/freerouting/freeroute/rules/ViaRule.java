...
public class ViaRule implements java.io.Serializable, net.freerouting.freeroute.board.ObjectInfoPanel.Printable {
     ...
     */
    public boolean contains_padstack(net.freerouting.freeroute.library.Padstack p_padstack) {
        for (ViaInfo curr_info : this.list) {
