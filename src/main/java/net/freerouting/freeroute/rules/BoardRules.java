...
public class BoardRules implements java.io.Serializable {
     ...
     */
    private transient net.freerouting.freeroute.board.AngleRestriction trace_angle_restriction;
    /**
     ...
     */
    public BoardRules(net.freerouting.freeroute.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix) {
     ...
     */
    public void change_clearance_class_no(int p_from_no, int p_to_no, java.util.Collection<net.freerouting.freeroute.board.Item> p_board_items) {
        for (net.freerouting.freeroute.board.Item curr_item : p_board_items) {
        ...
        for (int i = 0; i < this.net_classes.count(); ++i) {
            net.freerouting.freeroute.rules.NetClass curr_net_class = this.net_classes.get(i);
     ...
     */
    public boolean remove_clearance_class(int p_index, java.util.Collection<net.freerouting.freeroute.board.Item> p_board_items) {
        for (net.freerouting.freeroute.board.Item curr_item : p_board_items) {
     ...
     * result is {@literal <}= 0, there are no exit restrictions.
     */
     ...
     */
    public net.freerouting.freeroute.board.AngleRestriction get_trace_angle_restriction() {
     ...
     */
    public void set_trace_angle_restriction(net.freerouting.freeroute.board.AngleRestriction p_angle_restriction) {
    ...
    public double get_default_via_diameter() {
        ...
        net.freerouting.freeroute.library.Padstack via_padstack = default_via_rule.get_via(0).get_padstack();
    ...
    private void readObject(java.io.ObjectInputStream p_stream)
        ...
        this.trace_angle_restriction = net.freerouting.freeroute.board.AngleRestriction.lookup.get(snap_angle_no);
    }
