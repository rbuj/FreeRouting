...
public class NetClass implements java.io.Serializable, net.freerouting.freeroute.board.ObjectInfoPanel.Printable {
    ...
    private final net.freerouting.freeroute.board.LayerStructure board_layer_structure;
    /**
     ...
     * {@literal <}= 0, there is no minimal trace length restriction.
     */
     ...
     * {@literal <}= 0, there is no maximal trace length restriction.
     */
